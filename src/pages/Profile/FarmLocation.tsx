...
const FarmLocation = () => {
  ...
  useEffect(() => {
    ...
    const map = L.map(mapRef.current, { zoomControl: false }).setView([14.6760, 121.0437], 13);
  ...
  const placeMarker = (lat: number, lng: number, label: string) => {
    ...
    markerRef.current = L.marker([lat, lng], { icon })
      ...
      .bindPopup(`<b>${label}</b><br><small>${lat.toFixed(5)}, ${lng.toFixed(5)}</small>`, { closeButton: false })
      .openPopup();
  };
  ...
  const getCurrentLocation = () => {
    if (!navigator.geolocation) {
      showAlert('warning', 'Not Supported', 'Geolocation is not supported by your browser.');
      return;
    }
    setLocating(true);
    navigator.geolocation.getCurrentPosition(
      ...
      () => {
        showAlert('error', 'Location Error', 'Could not get your location. Please check your browser permissions and try again.');
        setLocating(false);
      }
    );
  };
      ...
      <Box maxW="780px" mx="auto" px={5}>
        ...
        <HStack mb={8} gap={4} align="center">
          ...
          <VStack align="start" gap={0}>
            <Heading size="2xl" color="gray.900" fontWeight="800">Default Farm Location</Heading>
        ...
        >
            ...
            <VStack gap={4} align="stretch">
              <Box>
                ...
                <Input
                  ...
                  size="md" borderRadius="10px" borderColor="gray.200"
          ...
          <Box px={8} pb={6}>
            <HStack justify="space-between" align="center" mb={3}>
              <VStack align="start" gap={0}>
                ...
                <Text fontSize="xs" color="gray.400" mt={0.5}>Click anywhere on the map to drop a pin</Text>
              </VStack>
              <HStack gap={2}>
                {hasCoords && (
                  <Badge bg="green.50" color="green.700" borderRadius="full" px={3} py={1} fontSize="xs" fontWeight="700" border="1px solid" borderColor="green.200">
                    <HStack gap={1}>
                      <LuMapPin size={10} />
                ...
                <Button
                  size="sm" variant="outline" colorScheme="blue" borderRadius="10px"
                  onClick={getCurrentLocation}
                  loading={locating} loadingText="Finding..."
            ...
            <Box
              ...
              border="2px solid" borderColor={pinDropped ? 'green.300' : 'gray.200'}
            ...
            >
              ...
              {!hasCoords && (
                <Box
                  ...
                  bg="blackAlpha.700" color="white" px={4} py={2} borderRadius="full"
                  fontSize="xs" fontWeight="600" pointerEvents="none" zIndex={1000}
                  display="flex" alignItems="center" gap={2}
                >
                  <LuMap size={12} /> Tap the map to set your farm location
                </Box>
              )}
            </Box>
          </Box>
          ...
          <Box px={8} pb={8}>
            <Button
              w="full" size="lg" borderRadius="12px" fontWeight="700" fontSize="sm"
              bg={saved ? 'green.500' : 'gray.900'} color="white"
        ...
        {/* Help tip */}
        <Box mt={5} p={4} bg="amber.50" borderRadius="14px" border="1px solid" borderColor="amber.200">
