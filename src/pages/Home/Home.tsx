...
const Home = () => {
  ...
  return (
    <Box
      ...
      // Override the global khaki gradient for auth pages
      sx={{
        'html &': {
    ...
    >
      ...
      >
        ...
        <Box
          ...
          h="320px"
          borderRadius="full"
          style={{ background: 'rgba(50,206,14,0.12)', filter: 'blur(60px)' }}
          pointerEvents="none"
        />
        <Box
          position="absolute"
        ...
        <Stack gap={10} w="100%" maxW="360px">
          ...
          <VStack gap={2} alignItems="flex-start" w="100%">
            ...
            <Text color="#888" fontSize="sm">
              Sign in to your farm dashboard or create a new account.
            </Text>
          </VStack>
          ...
          <Stack gap={3} w="100%">
            <Box
              ...
              onMouseEnter={(e: any) => {
                ...
                e.currentTarget.style.boxShadow = '0 8px 28px rgba(50,206,14,0.45)';
              }}
              onMouseLeave={(e: any) => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 4px 20px rgba(50,206,14,0.35)';
              }}
            >
              🔑 &nbsp; Sign In
            </Box>
            ...
            <Box
              ...
              onMouseEnter={(e: any) => {
                e.currentTarget.style.borderColor = '#32ce0e';
                e.currentTarget.style.color = '#28a80c';
                e.currentTarget.style.transform = 'translateY(-2px)';
              }}
              onMouseLeave={(e: any) => {
